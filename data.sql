...
-- Dumping structure for table gizi_fuzzy.table_data_balita
CREATE TABLE IF NOT EXISTS `table_data_balita` (
  ...
  `nama_ortu` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `alamat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `kecamatan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `usia_saat_ukur` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tgl_pengukuran` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tinggi` double DEFAULT NULL,
  `berat` double DEFAULT NULL,
  `status_tinggi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status_berat` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `status_gizi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fuzzy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id_balita`)
) ENGINE=InnoDB AUTO_INCREMENT=81 DEFAULT CHARSET=latin1;

-- Dumping data for table gizi_fuzzy.table_data_balita: ~80 rows (approximately)
DELETE FROM `table_data_balita`;
...
-- Dumping structure for table gizi_fuzzy.table_user
...
-- Dumping data for table gizi_fuzzy.table_user: ~1 rows (approximately)
