                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Balita Gizi Normal</p>
                                        <span class="title text-black font-w600">42 Orang</span>
                                    </div>
                                </div>
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Balita Gizi Berlebih</p>
                                        <span class="title text-black font-w600">42 Orang</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Balita Gizi Buruk</p>
                                        <span class="title text-black font-w600">0 Orang</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Total Balita Tercatat</p>
                                        <span class="title text-black font-w600">0 Orang</span>
                                    </div>
                                </div>
                                <div class="progress" style="height:5px;">
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                        <div class="mr-auto pr-3 mb-sm-0 mb-3">
                            <h4 class="text-black fs-20">Grafik Data Balita</h4>
                            <p class="fs-13 mb-0 text-black"></p>
                        </div>

                    </div>
                    <div class="card-body pt-0 pb-0">
                        <canvas width="500px" id="chartBar"></canvas>
                    </div>
                </div>
            </div>
        </div>
